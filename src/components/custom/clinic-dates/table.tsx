...
interface ClinicDateTableProps<TData, TValue> {
  ...
  setClinicId: (clinicId: number | null) => void;
...
export function ClinicDateTable<TData, TValue>({
  columns,
  data,
  clinicsData,
  search,
      ...
      <div className="mb-5 flex flex-col items-center justify-center gap-3 sm:flex-row sm:justify-between">
        <div className="flex gap-2 w-full sm:max-w-md">
          ...
          <Select
            ...
            onValueChange={(value) => {
              setClinicId(value ? parseInt(value, 10) : null);
            }}
          >
            <SelectTrigger className="w-32">
            ...
            <SelectContent>
              {clinicsData.length === 0 ? (
                <SelectItem value="0">No clinics available</SelectItem>
              ) : null}
