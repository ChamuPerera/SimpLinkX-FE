...
export const MakeAppointmentsPage: React.FC = () => {
  ...
  if (showConfirmation && appointmentDetails) {
    const service = [...opdServices, ...clinics].find(
      (s) => s.id === appointmentDetails.selectedClinic,
    );
            ...
            <div className="p-8">
              ...
              <div className="bg-green-50 border border-green-200 rounded-xl p-6 mb-6">
                <div className="flex items-center justify-center mb-4">
                  ...
                  <div>
                    ...
                    <p className="text-green-700">
                      Your appointment token has been successfully reserved
                    </p>
                  </div>
                </div>
                <div className="text-center text-sm text-green-600">
                  ...
                  <p className="mt-1">
                    Show this confirmation at the reception desk.
                  </p>
                </div>
              </div>
